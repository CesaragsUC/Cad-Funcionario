...
namespace CadFuncionario.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsuarioID,USER_NAME,USER_SENHA,PERFIL,ATIVO")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsuarioID,USER_NAME,USER_SENHA,PERFIL,ATIVO")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
